 ...
 *
 */
public  class JTextFieldDemo extends JDialog implements ActionListener  {
    ...
    public static void main(String[] args) {
        ...
        JTextFieldDemo d =new JTextFieldDemo(alertFrame, true,caipinMap,360,320);
        d.setVisible(true);
    }
     ...
     *             高度  默认320即可
     */
    public JTextFieldDemo(JFrame parent, boolean modal,Map<String,String> caipinMap,int windowWidth,int windowHeight) {
       super(parent,modal);
